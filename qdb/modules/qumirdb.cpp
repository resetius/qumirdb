...
const void* const QumirDbRuntimeSymbolAnchors[] __attribute__((used)) = {
    ...
    reinterpret_cast<const void*>(&qdb_string_view_cmp_cstr),
    reinterpret_cast<const void*>(&qdb_cstr_cmp_cstr),
    reinterpret_cast<const void*>(&qdb_sv_lit_eq),
    reinterpret_cast<const void*>(&qdb_sv_lit_ne),
    reinterpret_cast<const void*>(&qdb_sv_lit_lt),
    reinterpret_cast<const void*>(&qdb_sv_lit_le),
    reinterpret_cast<const void*>(&qdb_sv_lit_gt),
    reinterpret_cast<const void*>(&qdb_sv_lit_ge),
    reinterpret_cast<const void*>(&qdb_lit_sv_eq),
    reinterpret_cast<const void*>(&qdb_lit_sv_ne),
    reinterpret_cast<const void*>(&qdb_lit_sv_lt),
    reinterpret_cast<const void*>(&qdb_lit_sv_le),
    reinterpret_cast<const void*>(&qdb_lit_sv_gt),
    reinterpret_cast<const void*>(&qdb_lit_sv_ge),
    reinterpret_cast<const void*>(&qdb_lit_lit_eq),
    reinterpret_cast<const void*>(&qdb_lit_lit_ne),
    reinterpret_cast<const void*>(&qdb_lit_lit_lt),
    reinterpret_cast<const void*>(&qdb_lit_lit_le),
    reinterpret_cast<const void*>(&qdb_lit_lit_gt),
    reinterpret_cast<const void*>(&qdb_lit_lit_ge),
    ...
    reinterpret_cast<const void*>(&qdb_bitmap_set_valid),
