...
// Kernel ABI: single ctx parameter of type <ref <struct (n i64) (selection <ptr bool>) (col <ptr T>)...>>.
    ...
    const NQumir::NAst::TStructType& inputType)
{
    ...
    // Build the context struct type: (n i64) (selection <ptr bool>) (col <ptr T>)...
    ...
    ctxFields.emplace_back("selection",
        std::make_shared<TPointerType>(std::make_shared<TBoolType>()));
