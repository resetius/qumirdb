...
Query q05 is skipped by default because it requires DISTINCT over strings. Set
`ALLOW_UNSUPPORTED=1` to attempt it. Per-query timing prints to stdout; diagnostics go to
